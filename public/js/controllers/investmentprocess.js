...
.controller('investmentprocessCtrl', function ($scope, $state, $rootScope,$sce, $ionicLoading, $ionicModal,modalService, cordovafiletransferservice,$q, cordovacameraservice, httpservices, $ionicScrollDelegate, datastoreservice, cordovadialogservice) {
    ...
    paypal.Button.render({
        ...
        payment: function (data, actions) {
            ...
            return actions.payment.create({
                transactions: [
                    {
                        amount: { total: $scope.data.Investment_amount, currency: 'CAD' }
                    }
                ]
            });
    ...
    var app = {
        ...
        createPayment: function () {
            ...
            var paymentDetails = new PayPalPaymentDetails($scope.data.Investment_amount+50, "0.00", "0.00");
            var payment = new PayPalPayment($scope.data.Investment_amount + 50, "CAD", $scope.data.property_description_address, "Sale", paymentDetails);
            return payment;      },
