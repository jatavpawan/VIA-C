angular.module('document.controllers', [])

.controller('documentCtrl', function ($scope, $state, $ionicPopup, $ionicSlideBoxDelegate,$ionicModal, $ionicSideMenuDelegate) {
    var $signature='';
    ...
    $scope.save = function () {
        $scope.modal.hide();
        $scope.imgdata = signaturePad.toDataURL('image/png');
      //  console.log(data);
    }
    ...
    var app = {
        ...
        initPaymentUI: function () {
            var clientIDs = {
                "PayPalEnvironmentProduction": "AetX9148lTJgnGa7CnsonF10LzskS9GfwfRWgz0PsEHo3rRUuX2LdjIZWb4Cou7oA7UKutPOj85VZvTW",
                "PayPalEnvironmentSandbox": "AetX9148lTJgnGa7CnsonF10LzskS9GfwfRWgz0PsEHo3rRUuX2LdjIZWb4Cou7oA7UKutPOj85VZvTW"
            };
